...
<?php $this->need('header.php'); ?>
    ...
    <div class="archive-head">
        <div class="author-box">
            <div class="author-avatar"><img class="avatar-img" src="<?php $this->options->rootUrl(); ?>/favicon.png" /></div>
...
<img src="<?php echo __LAZYIMG__; ?>" data-original="<?php the_index_thumbnail($this);?>" alt="">
<?php else: ?>
