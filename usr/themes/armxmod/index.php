<?php
/**
 * <span style="color:#25b15e;font-weight:bold;">ArmX 响应式博客主题魔改版</span><br>简约而不简单，支持全站 Pjax，支持全文朗读，丰富的自定义模块；<br>魔改自 NatLiu's Armx；
 * 
 * @package <a href="https://blog.vircloud.net/default/change-theme.html" target="_blank" style="text-decoration:none;color:#444;" title="查看更新历史">ArmX Mod for Typecho</a>
 * @author 欧文斯
 * @version 2.1.1
 * @link https://blog.vircloud.net
 */
...
<?php $this->sticky(); ?> <?php new_or_update($this);?>
             ...
             <?php if(isset($this->fields->desc)){ 
               ...
               echo mb_substr(strip_tags($this->content), 0, 80, 'utf-8');
                                        ...
                                        ......<a href="<?php $this->permalink(); ?>" class="readmore" title="继续阅读">READ MORE</a></div>
					<div class="post-meta">
...
<span class="meta-item" title="" id="meta-view"><i class="fa fa-eye text-muted"></i>阅读(<?php get_post_view($this) ?>)</span>
